...
const basePoseTemplates = [
  ...
  },
  {
    ...
    skipSoftGuides: true,
    parts: [
      makeMarkerArc('cap-head-left', 33, 16, 18, 20, -24, 0.86),
      makeMarkerArc('cap-head-right', 44, 15, 17, 21, 20, 0.82),
      makeMarkerLine('cap-edge', 37, 18, 17, 8, 0.74),
      makeMarkerLine('left-arm-open-a', 35, 38, 24, 212, 0.88),
      makeMarkerArc('left-hand-curl', 23, 35, 10, 14, -25, 0.84),
      makeMarkerLine('right-arm-up-a', 55, 34, 30, 300, 0.9),
      makeMarkerLine('right-arm-up-b', 73, 12, 18, 326, 0.86),
      makeMarkerArc('raised-prop', 81, 2, 18, 22, 24, 0.8),
      makeMarkerArc('gown-left-outline', 27, 35, 23, 38, -22, 0.86),
      makeMarkerArc('gown-right-outline', 49, 31, 22, 41, 16, 0.86),
      makeMarkerLine('gown-bottom', 35, 68, 25, 5, 0.72),
      makeMarkerLine('support-leg', 44, 68, 27, 95, 0.76),
      makeMarkerLine('kick-thigh', 57, 58, 27, 20, 0.9),
      makeMarkerLine('kick-calf', 79, 66, 23, 10, 0.88),
      makeMarkerArc('shoe-outline', 94, 63, 10, 12, -20, 0.84),
  ...
  },
  {
    ...
    skipSoftGuides: true,
    parts: [
      makeMarkerArc('sit-head-left', 43, 18, 15, 17, -18, 0.84),
      makeMarkerArc('sit-head-right', 52, 18, 14, 17, 18, 0.82),
      makeMarkerLine('neck', 50, 34, 8, 94, 0.72),
      makeMarkerArc('shoulder-wrap', 39, 36, 26, 16, 4, 0.82),
      makeMarkerLine('back-arm-seat', 36, 43, 24, 170, 0.84),
      makeMarkerArc('left-hand-chair', 25, 42, 11, 13, -18, 0.78),
      makeMarkerLine('right-arm-down', 62, 42, 20, 74, 0.8),
      makeMarkerArc('torso-outline-left', 40, 36, 18, 30, -8, 0.82),
      makeMarkerArc('torso-outline-right', 52, 38, 17, 30, 12, 0.82),
      makeMarkerLine('bench-back', 24, 50, 52, 0, 0.42),
      makeMarkerLine('bench-seat', 30, 62, 46, 0, 0.46),
      makeMarkerLine('upper-leg-cross', 45, 62, 29, 16, 0.9),
      makeMarkerLine('lower-leg-cross', 60, 70, 19, 104, 0.82),
      makeMarkerLine('back-leg', 48, 66, 26, 118, 0.76),
      makeMarkerArc('front-shoe', 38, 81, 13, 10, -10, 0.82),
      makeMarkerArc('back-shoe', 63, 84, 13, 10, 8, 0.72),
