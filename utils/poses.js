...
const categoryDefinitions = [
  {
    ...
    poseNumbers: [38, 39, 41, 43, 44, 45, 46, 49, 91, 92, 94, 97, 99, 101, 106, 107, 109, 112, 113, 116, 117, 119, 120, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131]
  },
  {
    id: 'portrait-half',
    name: '头像半身照',
  ...
  },
  {
    ...
    poseNumbers: [13, 14, 17, 26, 31, 33, 44, 45, 48, 52, 53, 55, 57, 58, 59, 60, 61, 63, 69, 70, 72, 73, 4, 91, 93, 95, 96, 97, 98, 99, 100, 102, 103, 104, 105, 111, 113, 114, 117, 119, 121, 122, 123, 124, 125, 126, 127, 128, 129]
  },
  {
    id: 'back-view',
    name: '不露脸背影',
    subtitle: '不想看镜头时用，背影、回眸、转身和远景氛围照',
    poseNumbers: [11, 13, 14, 15, 16, 17, 26, 29, 31, 33, 35, 93, 96, 98, 100, 102, 104, 105, 109, 114, 122]
  },
  {
    id: 'props-action',
    name: '咖啡馆/道具',
  ...
  },
  {
    ...
    poseNumbers: [41, 83, 89, 92, 94, 101, 130]
  }
]
